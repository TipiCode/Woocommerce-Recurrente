...
if(empty($access_key) || empty($secret_key)){?>
    <div class="row alert-row" style="margin-bottom: .2rem !important;">
        <div class="alert alert-danger extra" style="padding:5px; border-radius: 10px; width:fit-content;width: 100%;max-width: 54rem; margin-right: 10%;">
...
<div class="grid">
        ...
        <div class="col">
            <div class="card-inicio " style="border-radius:20px;max-height: 250px; ">
                ...
                <div class="card-body-inicio" style="padding-bottom: 2.7vh; padding-top: 2.7vh;">
        ...
        <div class="col" style="    max-width: fit-content;">
            <div class="card-inicio  " style="border-radius:20px;max-height: 250px; ">
                ...
                <div class="card-body-inicio" style="    padding-right: 2.6rem; padding-left: 2.7rem;">
        ...
        <div class="col">
            <div class="card-inicio" style="border-radius:20px;max-height: 200px; width: fit-content;">
                ...
                <div class="card-body-inicio" style="padding-right: 26.5vh;     width: fit-content;     padding-bottom: 3.8rem;">
                    ...
                    <div class="row" style="max-width: 100%; gap: 1rem;     display: -webkit-inline-box;">
                        <div class="col">
            ...
            <div class="card-inicio" style="border-radius:20px;max-height: 200px;    margin-right: 0vh; width: fit-content;">
                ...
                <div class="card-body-inicio" style="padding-left:1.2rem;     padding-right: 1.2rem;">
                    ...
                    <div class="col" >
                        ...
                        <div class="row">
                            <a href="https://app.recurrente.com/s/aurora-u2u7iw/cafe-grande-con-leche" target="_blank"><button class="btn btn-primary-estado" style="padding: .4rem 2rem; margin-bottom: 1em;" target="_blank">Compra un cafe</button></a>
                        </div>
